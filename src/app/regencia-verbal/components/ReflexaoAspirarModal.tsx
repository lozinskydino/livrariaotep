...
export type ReflexaoAspirarModalProps = {
  open: boolean;
  onClose: () => void;
};

export default function ReflexaoAspirarModal({ open, onClose }: ReflexaoAspirarModalProps) {
  useEffect(() => {
    if (!open) return;
  ...
  return (
    ...
    >
      ...
      <div className="relative z-[1] w-full max-w-[393px] mx-auto px-4 sm:px-0 overflow-y-auto" style={{ maxHeight: "100dvh" }}>
        ...
        <div className="relative bg-[#E8F2DF] rounded-[16px] rounded-tl-[28px] rounded-tr-[12px] shadow-[0_12px_32px_rgba(0,0,0,0.2)] overflow-hidden">
          {/* Botão Voltar (fecha modal) */}
          <button
            onClick={onClose}
            className="absolute top-4 left-4 inline-flex items-center gap-2 bg-[#148017] text-white rounded-full pl-3 pr-3 py-[6px] shadow-[0_6px_14px_rgba(20,128,23,0.35)] hover:bg-[#0F6A13] transition cursor-pointer"
            aria-label="Voltar"
          >
          ...
          <div className="px-6 pt-10 pb-2 text-center">
            <h1 className={`${noto.className} text-[26px] leading-[30px] font-extrabold text-[#56AB2F]`}>Aspirar</h1>
          ...
          <div className="px-6 py-6 space-y-5">
            ...
            <div className="grid grid-cols-[188px_126px] gap-1 items-center">
              <div className="flex flex-row justify-start items-center px-[14px] w-[188px] h-[145px] bg-[#56AB2F] text-white rounded-[20px] shadow-[0_6px_16px_rgba(20,128,23,0.25)]">
                <p
                  className={`${noto.className} w-[166px] text-center text-white text-[14px] leading-[17px] font-[500]`}
                  style={{ letterSpacing: "-0.02em" }}
                >
                  “Aspirei <u>o</u> café” = Aqui temos o pó de café sendo sugado, neste caso pelo nariz.
                </p>
              </div>
              <div className="relative w-[126px] h-[145px] rounded-[20px] overflow-hidden">
                <div
                  ...
                  style={{
                    ...
                    left: -58,
                    top: -9,
                    backgroundImage: "url(/assets/images/regencia-verbal/aspirar-1.png)",
            ...
            <div className="grid grid-cols-[188px_126px] gap-1 items-center">
              <div className="flex flex-row justify-start items-center px-[14px] w-[188px] h-[145px] bg-[#56AB2F] text-white rounded-[20px] shadow-[0_6px_16px_rgba(20,128,23,0.25)]">
                <p
                  ...
                  style={{ letterSpacing: "-0.02em" }}
                >
                  “Aspirei <u>ao</u> café do Brasil” = Aqui temos uma pessoa que está desejando/almejando ter para si o café do Brasil.
                </p>
              </div>
              <div className="relative w-[126px] h-[145px] rounded-[20px] overflow-hidden">
                <div
                  ...
                  style={{
                    ...
                    left: -15,
                    top: -5,
                    backgroundImage: "url(/assets/images/regencia-verbal/aspirar-2.png)",
                    backgroundSize: "cover",
                    backgroundPosition: "center",
                  }}
                />
