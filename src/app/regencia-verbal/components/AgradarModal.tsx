...
/**
 * Modal do verbo "Agradar" baseado no Figma (node 8:558).
 * Paleta:
 * - Primária: #D74022
 * - Fundo do cartão principal: #F2EADF
 * - Texto corrido: #3A3A3A
 * - Exemplo (itálico): #878787
 */
export default function AgradarModal({ open, onClose, onVerReflexao }: AgradarModalProps) {
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-[1] w-full max-w-[393px] mx-auto px-4 sm:px-0 overflow-y-auto" style={{ maxHeight: "100dvh" }}>
        <div className="relative bg-[#F2EADF] rounded-[16px] rounded-tr-none shadow-[0_12px_32px_rgba(0,0,0,0.2)] overflow-hidden mb-4 min-h-[680px]">
          {/* Header */}
          <div className="relative flex items-center justify-center px-5 pt-8 pb-4">
            <h2 className={`${noto.className} text-center text-[28px] leading-[20px] font-extrabold tracking-[-0.56px]`} style={{ color: "#D74022" }}>
              Agradar
            </h2>
            <button
              aria-label="Fechar"
          ...
          {/* Corpo - timeline vermelha */}
          <div className="px-5 pb-5">
            <div className="relative">
              {/* Linha vertical */}
              <div className="absolute left-[23px] top-[70px] bottom-[80px] w-[2px] bg-[#D74022]" />
              ...
              <div className="space-y-4">
                ...
                <TimelineItem
                  ...
                  titleColor="#D74022"
                  title="Fazer carinho"
                  subtitle={`No sentido de fazer carinho, o verbo é transitivo direto, ou seja, não precisa de preposição.`}
                  exemploPrefix="Exemplo: "
                  exemploHtml={
                    <>
                      O pai agradava <u>o</u> filho.
                    </>
                  }
                />
                ...
                <TimelineItem
                  ...
                  titleColor="#D74022"
                  title="Satisfazer"
                  subtitle={`No sentido de satisfazer, o verbo é transitivo indireto, ou seja, é preciso o uso da preposição.`}
                  exemploPrefix="Exemplo: "
                  exemploHtml={
                    <>
                      O desempenho da atleta agradou <u>ao</u> treinador.
                    </>
                  }
                />
              </div>
          ...
          <div className="px-5 pb-5">
            <ModalCTAButton
              ...
              iconLeftAlt="Lâmpada"
              iconSize={18}
              className="whitespace-nowrap mx-[5px] !bg-[#802414] hover:!bg-[#6C1F12] shadow-[0_4px_30px_rgba(0,0,0,0.25)]"
            />
          </div>
        </div>
      </div>
