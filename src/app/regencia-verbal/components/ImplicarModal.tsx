...
/**
 * Modal do verbo "Implicar" seguindo o padrão do AssistirModal.
 * Paleta Figma (node 8:448):
 * - Primária (título, marcadores, linha): #CB2D3E
 * - Fundo do cartão principal: #F2DFDF
  ...
  return (
    ...
    >
      ...
      <div className="relative z-[1] w-full max-w-[393px] mx-auto px-4 sm:px-0 overflow-y-auto" style={{ maxHeight: "100dvh" }}>
        <div className="relative bg-[#F2DFDF] rounded-[16px] shadow-[0_12px_32px_rgba(0,0,0,0.2)] overflow-hidden mb-4 min-h-[795px]">
          {/* Header */}
          <div className="relative flex items-center justify-center px-5 pt-8 pb-4">
            <h2 className={`${noto.className} text-center text-[22px] leading-[26px] font-extrabold text-[#CB2D3E]`}>
              Implicar
            </h2>
            <button
              aria-label="Fechar"
          ...
          <div className="px-5 pb-5">
            <div className="relative">
              {/* Linha vertical */}
              <div className="absolute left-[23px] top-[70px] bottom-[70px] w-[2px] bg-[#CB2D3E]" />
              ...
              <div className="space-y-4">
                ...
                <TimelineItem
                  ...
                  titleColor="#CB2D3E"
                  title="Provocar"
                  subtitle={`No sentido de “provocar”, “amolar”, o verbo é intransitivo e precisa da preposição “com”.`}
                  exemploPrefix="Exemplo: "
                  exemploHtml={
                    <>
                      Meu irmão gosta de implicar <u>comigo</u> ou “Meu irmão gosta de implicar <u>com</u> todos”.
                    </>
                  }
                />
                ...
                <TimelineItem
                  ...
                  titleColor="#CB2D3E"
                  title="Acarretar"
                  subtitle={`No sentido de “ter como consequência”, “acarretar”, “provocar”, o verbo é transitivo direto, ou seja, sem preposição.`}
                  exemploPrefix="Exemplo: "
                  exemploHtml={
                    <>
                      A perda da comanda implicará <u>o</u> pagamento de multa.
                    </>
                  }
                />
              </div>
