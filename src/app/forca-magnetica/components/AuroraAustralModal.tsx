          ...
          <div className="flex flex-col items-center h-full px-10 pt-[80px] pb-10 gap-3 overflow-y-auto overflow-x-hidden" style={{ paddingLeft: "50px" }}>
            ...
            <div className="bg-[#B169FA] border-2 border-[#641671] rounded-[16px] z-0 flex-none order-0 w-full" style={{ padding: "14px 10px" }}>
              <div className="w-full flex flex-col items-start gap-4 z-20 relative">
                {/* Main description */}
                <p className="text-white font-nunito font-semibold text-[16px] leading-[1.2] flex-none order-0 self-stretch z-[2]">Por elas se formarem com maior precisão na Antártida, as auroras austrais são mais difíceis de serem observadas a olho nu. Porém, em alguns lugares, dependendo da estação do ano, isso é possível.</p>
