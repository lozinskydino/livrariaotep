            ...
            <div className="bg-[#B169FA] border-2 border-[#641671] rounded-[16px] z-0 flex-none order-0 w-full" style={{ padding: "14px 10px" }}>
              <div className="w-full flex flex-col items-start gap-4 z-20 relative">
                ...
                <div className="w-full flex flex-col gap-4">
                  {/* Título Canadá */}
                  <p className="text-white font-nunito font-semibold text-[16px] leading-[1.2] flex-none self-stretch z-[2]">Canadá, nas cidades de:</p>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div
                      ...
                      style={{
                        backgroundImage: "linear-gradient(180deg, rgba(0, 0, 0, 1) 0%, rgba(0, 0, 0, 0.1) 100%), url('/assets/images/forca-magnetica/edmonton.jpg')",
                        backgroundSize: "cover",
                        backgroundPosition: "center",
                        isolation: "isolate",
                      }}>
                      <p className="text-white font-nunito font-bold text-[16px] absolute top-2 left-3">Edmonton</p>
                    </div>
