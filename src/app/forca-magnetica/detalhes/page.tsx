...
export default function ForcaMagneticaDetalhes() {
  ...
  return (
    <div className="relative overflow-hidden w-full min-h-screen bg-gradient-to-b from-[#9C59FE] to-[#420C66]">
      <div className="flex flex-col justify-between items-center w-[363px] min-h-screen mx-auto gap-10 p-10 pl-[50px] md:gap-16">
        {/* Background Image */}
        ...
        <div className="relative z-10 flex flex-row justify-stretch items-stretch w-full gap-6">
          <Botao onClick={handleVoltarClick} label="VOLTAR" variant="azul" height="64" />
          <Botao onClick={handleAvancarClick} label="AVANÇAR" variant="verde" height="64" />
        </div>
      </div>
    </div>
  );
