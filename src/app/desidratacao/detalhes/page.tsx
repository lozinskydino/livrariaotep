...
export default function DesidratacaoDetalhes() {
  ...
  return (
    <div className="relative overflow-hidden flex flex-col justify-between items-center min-h-screen mx-auto gap-10 p-10 bg-gradient-to-b from-[#FF69B4] to-[#FF1493] pl-[50px]">
