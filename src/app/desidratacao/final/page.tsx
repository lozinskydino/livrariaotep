...
export default function DesidratacaoFinal() {
  ...
  return (
    <div className="relative h-screen mx-auto overflow-x-hidden flex justify-center bg-gradient-to-b from-[#FF69B4] to-[#FF1493]">
      <div className="w-[393px] lg:w-[500px] relative">
        ...
        <div className="absolute right-4 z-5">
          <div className="animate-floating">
            <Image src="/assets/images/desidratacao/bombom.png" alt="bombom" width={138} height={56} />
          </div>
        </div>

        {/* Logo do Desidrata o */}
        <div className="flex sticky w-full justify-center mt-20 z-10">
          <Image src="/assets/images/desidratacao/logo.png" alt="Logo Desidratação" width={233} height={190} className="object-contain" />
        </div>

        {/* Elementos decorativos - pirulito invertido no canto superior direito */}
        <div className="absolute right-0 lg:right-[-16px] top-[280px] z-20">
          <div className="animate-floating">
            <Image src="/assets/images/desidratacao/pirulito.png" alt="Pirulito" width={104} height={181} className="transform scale-x-[-1]" />
          </div>
        </div>
        ...
        <div className="z-10 flex flex-col items-center justify-center pt-3 p-[40px] w-full">
          ...
          <div className="bg-[#A03BB1] border-4 border-white rounded-[16px] flex flex-col justify-end items-start gap-4 relative mb-8 w-full max-w-[313px] lg:max-w-[500px]" style={{ padding: "0px 5px 7px 0px" }}>
