...
export default function BoricoInseticida() {
      ...
      <div className="w-[393px] min-h-screen">
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 p-6 pt-6 w-full">
          ...
          <div className="w-[260px] bg-white rounded-xl p-4 flex flex-col gap-3">
            <div className={`${inter.className} font-semibold text-[#00076C] text-left tracking-[-0.16px] text-[14px]`}>Inseticida doméstico</div>
            ...
            <div className={`${inter.className} font-normal text-[12px] leading-[16px] tracking-[-0.12px] text-neutral-700`}>
              O ácido bórico atua como inseticida principalmente devido às suas propriedades tóxicas para insetos e sua
              capacidade de desidratá-los. Ele interfere no sistema digestivo e no metabolismo dos insetos ao ser ingerido,
              causando morte por envenenamento. Quando aplicado em pó, também provoca abrasão na camada externa do exoesqueleto,
              levando à perda de água e à desidratação. Pela baixa toxicidade para humanos e animais de grande porte, é amplamente
              utilizado no controle de baratas, formigas e outros insetos domésticos.
            </div>
          </div>
