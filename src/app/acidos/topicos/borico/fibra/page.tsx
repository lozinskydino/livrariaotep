...
export default function BoricoFibra() {
      ...
      <div className="w-[393px] min-h-screen">
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 p-6 pt-6 w-full">
          ...
          <div className="w-[260px] bg-white rounded-xl p-4 flex flex-col gap-3">
            <div className={`${inter.className} font-semibold text-[#00076C] text-left tracking-[-0.16px] text-[14px]`}>Fabricação de fibra de vidro</div>

            <div className="relative w-full h-[120px] bg-white rounded-xl overflow-hidden">
              <div className="absolute inset-0 bg-center bg-cover" style={{ backgroundImage: `url('${IMG_FIBRA}')` }} />
            ...
            <div className={`${inter.className} font-normal text-[12px] leading-[16px] tracking-[-0.12px] text-neutral-700`}>
              As fibras de vidro são materiais leves e resistentes, usadas em isolamento térmico e acústico, telhas, barcos e
              materiais automotivos. Durante sua fabricação, o ácido bórico é essencial para reduzir a temperatura de fusão e
              garantir a formação uniforme das fibras, aumentando a resistência térmica e química do material, conferindo mais
              durabilidade e eficiência em sua aplicação.
            </div>
          </div>
