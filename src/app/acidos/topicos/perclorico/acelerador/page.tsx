...
export default function PerchloricoAcelerador() {
      ...
      <div className="w-[393px] min-h-screen">
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 p-6 pt-6 w-full">
          ...
          <div className="w-[260px] bg-white rounded-xl p-4 flex flex-col gap-3">
            <div className={`${inter.className} font-semibold text-[#00076C] text-left tracking-[-0.16px] text-[14px]`}>Acelerador de reações</div>

            <div className="relative w-full h-[120px] bg-white rounded-xl overflow-hidden">
              <div className="absolute inset-0 bg-center bg-cover" style={{ backgroundImage: `url('${IMG_ACELERADOR}')` }} />
            ...
            <div className={`${inter.className} font-normal text-[12px] leading-[16px] tracking-[-0.12px] text-neutral-700`}>
              O ácido perclórico é utilizado como acelerador de reações químicas, ajudando a tornar os processos mais rápidos e eficientes. Ele faz isso ao aumentar a velocidade com que os reagentes se transformam nos produtos desejados, sendo muito aplicado em indústrias que precisam otimizar o tempo de fabricação de determinados compostos.
            </div>
          </div>
