...
export default function PerchloricoHerbicida() {
      ...
      <div className="w-[393px] min-h-screen">
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 p-6 pt-6 w-full">
          ...
          <div className="w-[260px] bg-white rounded-xl p-4 flex flex-col gap-3">
            <div className={`${inter.className} font-semibold text-[#00076C] text-left tracking-[-0.16px] text-[14px]`}>Controle de pragas (herbicida)</div>

            <div className="relative w-full h-[120px] bg-white rounded-xl overflow-hidden">
              <div className="absolute inset-0 bg-center bg-cover" style={{ backgroundImage: `url('${IMG_HERBICIDA}')` }} />
            ...
            <div className={`${inter.className} font-normal text-[12px] leading-[16px] tracking-[-0.12px] text-neutral-700`}>
              O ácido perclórico é utilizado na formulação de herbicidas devido à capacidade de interferir nos processos metabólicos das plantas. Como agente químico nocivo para espécies invasoras, ele atua de forma localizada, sem ser absorvido pelas culturas agrícolas, impedindo a proliferação de ervas daninhas e plantas consideradas indesejadas. Isso contribui para a proteção de cultivos e para o aumento da produtividade nas lavouras.
            </div>
          </div>
