      ...
      <div className="w-[393px]">
        ...
        <div className="flex flex-col items-center w-full mt-[50px] gap-6">
          <div className="w-[313px] h-[160px] relative rounded-[16px] overflow-hidden mb-[40px]">
            <Image src="/assets/images/artropodes/logo.svg" alt="Artrópodes e Equinodermos" fill className="object-cover min-h-[190px]" />
          </div>
            ...
            <div className="bg-[#EBF3EE] border-2 border-[#1C4F46] rounded-[16px] z-0 flex-none order-0 w-full p-[14px_10px]">
              <div className="w-full flex flex-col items-start gap-4 z-20 relative">
                ...
                <p className="text-[#1C4F46] font-nunito font-semibold text-[16px] leading-[1.2] flex-none order-0 self-stretch z-[2]">
                  Os artrópodes são os animais mais numerosos da Terra. São caracterizados pela presença de apêndices articulados e um exoesqueleto que precisa ser mudado de tempos em tempos durante o crescimento do animal. No caso dos crustáceos, muitos são utilizados na gastronomia. No grupo dos equinodermos estão as estrelas-do-mar, animais com o corpo repleto de espinhos e que têm alta capacidade de regeneração. Assim, ao encontrar uma estrela-do-mar faltando um ou mais braços, lembre-se de que ela provavelmente sobreviverá e regenerará os braços que perdeu. Quando consumir frutos do mar,
                  lembre-se de que pode estar ingerindo representantes do grupo dos moluscos, dos artrópodes, no caso de crustáceos, e também de equinodermos, pois pepinos-do-mar e ovas de ouriço também são usados como alimentos.
                </p>
              </div>
            </div>
          </div>
