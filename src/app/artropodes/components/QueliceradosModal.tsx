...
interface QueliceradosModalProps {
  isOpen: boolean;
  onClose: () => void;
  onHome: () => void;
}

const QueliceradosModal: React.FC<QueliceradosModalProps> = ({ isOpen, onClose, onHome }) => {
          ...
          <div className="w-[313px] bg-[#41AA98] border-4 border-white rounded-[16px] flex flex-col justify-end items-start gap-4 relative pt-0 pr-[5px] pb-[7px] pl-0">
            <div className="bg-[#EBF3EE] border-2 border-[#1C4F46] rounded-[16px] z-0 flex-none order-0 w-full p-[14px_10px]">
              <div className="w-full flex flex-col items-start gap-4 z-20 relative">
                <h1 className="w-[281px] h-[22px] font-nunito font-extrabold text-[18px] leading-[1.2] text-[#1C4F46] flex-none order-0 flex-grow-1">Quelicerados</h1>

                {/* Imagem principal do topo */}
                <div className="w-full flex justify-center">
                  <div className="flex flex-col justify-center items-center p-2 gap-2 w-[281px] h-[160px] rounded-[16px] relative bg-[url('/assets/images/artropodes/quelicerados-modal-1.png')] bg-cover bg-center">
                  </div>
                </div>
                ...
                {/* Terceira seção - Imagem + Botão 3 */}
                <div className="w-full flex flex-col gap-4">
                  <div className="w-full flex justify-center">
                    <div
                      className="flex flex-col justify-center items-center p-2 gap-2 w-[281px] h-[160px] rounded-[16px] relative"
                      style={{
                        backgroundImage: `url('/assets/images/artropodes/quelicerados-modal-3.png')`,
                        backgroundSize: "cover",
                        backgroundPosition: "center",
                      }}>
                    </div>
                ...
                {/* Quarta seção - Imagem + Botão 4 */}
                <div className="w-full flex flex-col gap-4">
                  <div className="w-full flex justify-center">
                    <div
                      className="flex flex-col justify-center items-center p-2 gap-2 w-[281px] h-[160px] rounded-[16px] relative">
                      <VideoPlayer src="https://player.vimeo.com/video/1100711689?h=654e25463a&badge=0&autopause=0&player_id=0&app_id=58479" />
                    </div>
                  </div>
                  <div className="w-full flex justify-center">
                    <div
                      className="flex flex-col justify-center items-center p-2 gap-2 w-[281px] h-[160px] rounded-[16px] relative bg-gray-800"
                      style={{
                        backgroundImage: `url('/assets/images/artropodes/quelicerados-modal-4.png')`,
                        backgroundSize: "cover",
                        backgroundPosition: "center",
                      }}>
                    </div>
...
export default QueliceradosModal;
