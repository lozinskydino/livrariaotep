            ...
            <div className="bg-[#EBF3EE] border-2 border-[#1C4F46] rounded-[16px] z-0 flex-none order-0 w-full p-[14px_10px]">
              <div className="w-full flex flex-col items-start gap-4 z-20 relative">
                ...
                <div className="w-full flex justify-center">
                  <div className="flex flex-col justify-center items-center p-2 gap-2 w-[281px] h-[280px] rounded-[16px] relative bg-[url('/assets/images/artropodes/equinodermos-modal-1.png')] bg-cover bg-center"></div>
                </div>

                {/* Primeira seção com botão 1 */}
                <div className="w-full flex flex-col gap-4">
                  <div className="flex items-start gap-2">
                    <p className="text-[#1C4F46] font-nunito font-semibold text-[16px] leading-[1.2] flex-1">Apresentam espinhos na superfície do corpo e são exclusivamente marinhos.</p>
                  </div>
                </div>
                ...
                <div className="w-full flex flex-col gap-4">
                  <div className="flex items-start gap-2">
                    <p className="text-[#1C4F46] font-nunito font-semibold text-[16px] leading-[1.2] flex-1">São representados por estrelas-do-mar, serpentes-do-mar, ouriços-do-mar, bolachas da praia, lírio-do-mar e pepinos-do-mar. Apresentam grande capacidade de regeneração. Uma estrela-do-mar, por exemplo, pode regenerar braços perdidos.</p>
                  </div>
                </div>

                {/* Terceira seção - Imagem */}
                <div className="w-full flex justify-center">
                  <div className="flex flex-col justify-center items-center p-2 gap-2 w-[281px] h-[160px] rounded-[16px] relative bg-[url('/assets/images/artropodes/equinodermos-modal-2.png')] bg-cover bg-center"></div>
                </div>

                {/* Quarta seção - Botão 3 + Texto */}
                <div className="w-full flex flex-col gap-4">
                  <div className="flex items-start gap-2">
                    <p className="text-[#1C4F46] font-nunito font-semibold text-[16px] leading-[1.2] flex-1">Apresentam um endoesqueleto calcário e um sistema exclusivo denominado ambulacrário, importante para a locomoção do animal. Dele se projetam os pés ambulacrários bem visíveis na estrela-do-mar.</p>
                  </div>
                </div>
