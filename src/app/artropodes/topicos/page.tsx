...
export default function ArtropodesTopicos() {
  ...
  return (
    <div className="relative overflow-hidden flex flex-col justify-center items-center min-h-screen mx-auto bg-gradient-to-b from-[#41AA98] to-[#EBF3EE]">
      <div className="w-[393px]">
        ...
        <div className="flex flex-col items-center w-full pt-[40px] px-4">
          ...
          <div className="flex gap-3 mb-6 w-full max-w-[315px]">
            ...
            <div className="flex-1 bg-[#41AA98] border-4 border-white rounded-[16px] pr-[5px] pb-[5px] cursor-pointer" onClick={handleArtropodesClick}>
              <div className="bg-[#EBF3EE] hover:bg-[#b9dac7] border-2 border-[#1C4F46] rounded-[16px] p-4">
                <h2 className="text-[#1C4F46] font-nunito font-extrabold text-[17px] leading-[1.2] text-center">Artrópodes</h2>
              </div>
            </div>
            ...
            <div className="flex-1 bg-[#41AA98] border-4 border-white rounded-[16px] pr-[5px] pb-[5px] cursor-pointer" onClick={handleEquinodermosClick}>
              <div className="bg-[#EBF3EE] hover:bg-[#b9dac7] border-2 border-[#1C4F46] rounded-[16px] p-4">
                <h2 className="text-[#1C4F46] font-nunito font-extrabold text-[17px] leading-[1.2] text-center">Equinodermos</h2>
              </div>
            </div>
          </div>
        ...
        {/* Modal dos Insetos */}
        <InsetosModal isOpen={isInsetosModalOpen} onClose={handleCloseModal} onHome={handleHomeClick} />

        {/* Modal dos Artrópodes */}
        <ArtropodesModal isOpen={isArtropodesModalOpen} onClose={handleCloseModal} onHome={handleHomeClick} />

        {/* Modal dos Crustáceos */}
        <CrustaceosModal isOpen={isCrustaceosModalOpen} onClose={handleCloseModal} onHome={handleHomeClick} />

        {/* Modal dos Quelicerados */}
        <QueliceradosModal isOpen={isQueliceradosModalOpen} onClose={handleCloseModal} onHome={handleHomeClick} />

        {/* Modal dos Miriápodes */}
        <MiriapodesModal isOpen={isMiriapodesModalOpen} onClose={handleCloseModal} onHome={handleHomeClick} />

        {/* Modal dos Equinodermos */}
        <EquinodermosModal isOpen={isEquinodermosModalOpen} onClose={handleCloseModal} onHome={handleHomeClick} />
